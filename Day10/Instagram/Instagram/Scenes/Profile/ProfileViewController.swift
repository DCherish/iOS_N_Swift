...
final class ProfileViewController: UIViewController {
    ...
    private let photoDataView = ProfileDataView(count: 123, title: "게시물")
    private let followerDataView = ProfileDataView(count: 2_000, title: "팔로워")
    private let followingDataView = ProfileDataView(count: 1, title: "팔로잉")
...
private extension ProfileViewController {
    ...
    func setupLayout() {
        ...
        nameLabel.snp.makeConstraints {
            $0.top.equalTo(profileImageView.snp.bottom).offset(22.0)
